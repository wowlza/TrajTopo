...
formatted_data1={'austin':'/data/pkl/austin-csv.pkl'}
formatted_data=pickle.load(open(formatted_data1['austin'],"rb"))
...
json_filename = '/data/lza/olv2-traj-data/test_traj_data/log_id_info_missing.json'
with open(json_filename, 'r') as jsonfile:
    data = json.load(jsonfile)
...
#生成文件夹
state_folder='/home/jpj/lzy/output/state_output/austin-csv'
    ...
    try:
        for info in infos:
            ...
            #                 return
                ...
                # os.makedirs(state_folder, exist_ok=True)
                # state_file_path = os.path.join(state_folder, f'{token}_{segment_id}.json')
                subfolder_path = os.path.join('/data/jpj/val/austin-csv', segment_id)
...
process_info(infos['train'].values())
