...
formatted_data1={'washington-dc3':'/data/pkl/washington-dc3-csv.pkl'}
formatted_data=pickle.load(open(formatted_data1['washington-dc3'],"rb"))
...
#生成文件夹
state_folder='/home/jpj/lzy/output/state_output/washington-dc3-csv'
def process_info(info):
    try:
        ...
        #                 return
            ...
            state_file_path = os.path.join(state_folder, f'{token}_{segment_id}.json')
            subfolder_path = os.path.join('/data/jpj/val/washington-dc3-csv', segment_id)
