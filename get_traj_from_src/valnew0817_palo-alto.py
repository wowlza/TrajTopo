...
formatted_data1={'palo-alto':'/data/pkl/palo-alto-csv.pkl'}
formatted_data=pickle.load(open(formatted_data1['palo-alto'],"rb"))
...
#生成文件夹
state_folder='/home/jpj/lzy/output/state_output/palo-alto-csv'
def process_info(info):
    try:
        ...
        #                 return
            ...
            state_file_path = os.path.join(state_folder, f'{token}_{segment_id}.json')
            subfolder_path = os.path.join('/data/jpj/val/palo-alto-csv', segment_id)
