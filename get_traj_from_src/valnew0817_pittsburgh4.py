...
formatted_data1={'pittsburgh4':'/data/pkl/pittsburgh4-csv.pkl'}
formatted_data=pickle.load(open(formatted_data1['pittsburgh4'],"rb"))
...
#生成文件夹
state_folder='/home/jpj/lzy/output/state_output/pittsburgh4-csv'
test = ['10068','10103','10113','10067','10082']
def process_info(info):
    try:
        ...
        print(token)
        if city_name == "pittsburgh" and segment_id in test:
        ...
        #                 return
            ...
            state_file_path = os.path.join(state_folder, f'{token}_{segment_id}.json')
            subfolder_path = os.path.join('/data/jpj/val/pittsburgh4-csv', segment_id)
