...
formatted_data1={'dearborn':'/data/pkl/dearborn-csv.pkl'}
formatted_data=pickle.load(open(formatted_data1['dearborn'],"rb"))
...
#生成文件夹
state_folder='/home/jpj/lzy/output/state_output/dearborn-csv'
            ...
            if os.path.exists(state_file_path):
                with open(state_file_path, 'r') as f:
                    ...
                    if state['status'] == 'processed':
                        ...
                        return
            # state_file_path = os.path.join(state_folder, f'{token}_{segment_id}.json')
            subfolder_path = os.path.join('/data/jpj/val/dearborn-csv', segment_id)
