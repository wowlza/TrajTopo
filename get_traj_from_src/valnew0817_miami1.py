...
formatted_data1={'miami1':'/data/pkl/miami1-csv.pkl'}
formatted_data=pickle.load(open(formatted_data1['miami1'],"rb"))
...
#生成文件夹
state_folder='/home/jpj/lzy/output/state_output/miami1-csv'
def process_info(info):
    try:
        ...
        # if json_name in miami_dict and segment_id == miami_dict[json_name]['segment_id']:
            ...
            # os.makedirs(state_folder, exist_ok=True)
            # state_file_path = os.path.join(state_folder, f'{token}_{segment_id}.json')
            subfolder_path = os.path.join('/data/jpj/val/miami1-csv', segment_id)
