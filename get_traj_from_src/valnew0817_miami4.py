...
formatted_data1={'miami4':'/data/pkl/miami4-csv.pkl'}
formatted_data=pickle.load(open(formatted_data1['miami4'],"rb"))
...
#生成文件夹
state_folder='/home/jpj/lzy/output/state_output/miami4-csv'
def process_info(info):
    try:
        ...
        #                 return
            ...
            # os.makedirs(state_folder, exist_ok=True)
            # state_file_path = os.path.join(state_folder, f'{token}_{segment_id}.json')
            subfolder_path = os.path.join('/data/jpj/val/miami4-csv', segment_id)
