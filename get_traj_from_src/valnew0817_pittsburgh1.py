...
formatted_data1={'pittsburgh1':'/data/pkl/pittsburgh1-csv.pkl'}
formatted_data=pickle.load(open(formatted_data1['pittsburgh1'],"rb"))
...
#生成文件夹
state_folder='/home/jpj/lzy/output/state_output/pittsburgh1-csv'
def process_info(info):
    try:
        ...
        #                 return
            ...
            state_file_path = os.path.join(state_folder, f'{token}_{segment_id}.json')
            subfolder_path = os.path.join('/data/jpj/val/pittsburgh1-csv', segment_id)
