...
formatted_data1={'miami3':'/data/pkl/miami3-csv.pkl'}
formatted_data=pickle.load(open(formatted_data1['miami3'],"rb"))
...
#生成文件夹
state_folder='/home/jpj/lzy/output/state_output/miami3-csv'
def process_info(info):
    try:
        ...
        #                 return
            ...
            # os.makedirs(state_folder, exist_ok=True)
            # state_file_path = os.path.join(state_folder, f'{token}_{segment_id}.json')
            subfolder_path = os.path.join('/data/jpj/val/miami3-csv', segment_id)
