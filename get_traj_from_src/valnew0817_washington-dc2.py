...
formatted_data1={'washington-dc2':'/data/pkl/washington-dc2-csv.pkl'}
formatted_data=pickle.load(open(formatted_data1['washington-dc2'],"rb"))
...
#生成文件夹
state_folder='/home/jpj/lzy/output/state_output/washington-dc2-csv'
def process_info(info):
    try:
        ...
        #                 return
            ...
            state_file_path = os.path.join(state_folder, f'{token}_{segment_id}.json')
            subfolder_path = os.path.join('/data/jpj/val/washington-dc2-csv', segment_id)
